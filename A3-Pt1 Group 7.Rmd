...
aware_pop <- pop_data |>
  filter(!country %in% c('Asian & Pacific Islands', 'Caribbean', 'Sub-Saharan Africa', 'Taiwan')) |> 
  inner_join(aware_fixed_country_match, by = 'country') |>
  select(country,total_population = SP.POP.TOTL, aware_no, aware_alittle, aware_moderate, aware_alot, aware_refuse) 
