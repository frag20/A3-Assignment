...
# Abstract
In this report, we analyze relationships between hurricane intensity, sea ice extent, and climate awareness using cleaned datasets from Part 1. By combining insights from three data sources, we explore whether hurricane strength is related to sea ice extent and whether climate awareness correlates with happiness. We use summary statistics, visualizations, and correlations to investigate these questions, and we conclude with insights that examine and show the complexities of climate change perceptions and impacts.
